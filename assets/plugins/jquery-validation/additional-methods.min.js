...
jQuery.validator.addMethod("pasaporte", function(value, element) {
  // allow any non-whitespace characters as the host part
  return this.optional( element ) || /^[a-zA-Z]{1}[0-9]{10}$/.test( value );
}, 'El pasaporte es incorrecto. Ej:A1234567890');
